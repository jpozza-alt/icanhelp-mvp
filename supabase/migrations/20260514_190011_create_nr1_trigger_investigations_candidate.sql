-- MIGRATION CANDIDATA - INVESTIGACAO DE GATILHOS NR1
-- Projeto: icanHelp NR1
-- Status: CANDIDATA LOCAL
-- Origem: docs/nr1/DDL_RASCUNHO_INVESTIGACAO_GATILHOS.sql
-- Importante:
-- Este arquivo ainda NAO foi aplicado no banco.
-- Revisar antes de executar migration real.
-- Regra de produto:
